...
[![Synchronisation Jira](https://github.com/groupie-tracker-zone01/groupie-tracker/actions/workflows/sync-jira.yml/badge.svg?branch=main)](https://github.com/groupie-tracker-zone01/groupie-tracker/actions/workflows/sync-jira.yml)
...
GitHub est la source de vérité pour l'avancement. Une assignation, une libération ou la fermeture d'un ticket déclenche immédiatement la synchronisation vers Jira. Une réconciliation complète est aussi exécutée toutes les 15 minutes et chaque jour à 08:00 (heure de Paris). Le badge ci-dessus signale directement tout échec.
